"""
zdppy_password_hash.utils.md4 - DEPRECATED MODULE, WILL BE REMOVED IN 2.0

MD4 should now be looked up through ``zdppy_password_hash.crypto.digest.lookup_hash("md4").const``,
...
warn("the module 'zdppy_password_hash.utils.md4' is deprecated as of Passlib 1.7, "
     "and will be removed in Passlib 2.0, please use "
     "'lookup_hash(\"md4\").const()' from 'zdppy_password_hash.crypto' instead",
     DeprecationWarning)
