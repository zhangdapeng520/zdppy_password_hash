"""
zdppy_password_hash.hash - proxy object mapping hash scheme names -> handlers
...
This proxy object (zdppy_password_hash.registry._PasslibRegistryProxy)
handles lazy-loading hashes as they are requested.

The actual implementation of the various hashes is store elsewhere,
mainly in the submodules of the ``zdppy_password_hash.handlers`` subpackage.
"""
