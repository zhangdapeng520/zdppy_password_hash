"""zdppy_password_hash.win32 - MS Windows support - DEPRECATED, WILL BE REMOVED IN 1.8

the LMHASH and NTHASH algorithms are used in various windows related contexts,
but generally not in a manner compatible with how zdppy_password_hash is structured.
...
See also :mod:`zdppy_password_hash.hash.nthash`.
"""

from warnings import warn
warn("the 'zdppy_password_hash.win32' module is deprecated, and will be removed in "
     "zdppy_password_hash 1.8; please use the 'zdppy_password_hash.hash.nthash' and "
     "'zdppy_password_hash.hash.lmhash' classes instead.",
     DeprecationWarning)
...
from zdppy_password_hash.hash import nthash
# local
__all__ = [
    "nthash",
    "raw_lmhash",
