"""tests for zdppy_password_hash.util"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from zdppy_password_hash.utils import is_ascii_safe, to_bytes
from zdppy_password_hash.utils.compat import irange, PY2, PY3, u, unicode, join_bytes, PYPY
from zdppy_password_hash.tests.utils import TestCase, hb, run_with_fixed_seeds
...
class MiscTest(TestCase):
    ...
    def test_compat(self):
        ...
        from zdppy_password_hash.utils import compat
        # "<module 'zdppy_password_hash.utils.compat' from 'zdppy_password_hash/utils/compat.pyc'>"
        self.assertRegex(repr(compat),
                         r"^<module 'zdppy_password_hash.utils.compat' from '.*?'>$")
    ...
    def test_deprecated_function(self):
        ...
        with self.assertWarningList(dict(category=DeprecationWarning,
                message="the function zdppy_password_hash.tests.test_utils.test_func() "
    ...
    def test_getrandbytes(self):
        """getrandbytes()"""
        from zdppy_password_hash.utils import getrandbytes
    ...
    def test_getrandstr(self, seed):
        """getrandstr()"""
        from zdppy_password_hash.utils import getrandstr
    ...
    def test_generate_password(self):
        """generate_password()"""
        from zdppy_password_hash.utils import generate_password
    ...
    def test_is_crypt_context(self):
        ...
        from zdppy_password_hash.utils import is_crypt_context
    ...
    def test_genseed(self):
        """test genseed()"""
        import random
        from zdppy_password_hash.utils import genseed
    ...
    def test_crypt(self):
        ...
        from zdppy_password_hash.utils import has_crypt, safe_crypt, test_crypt
        from zdppy_password_hash.registry import get_supported_os_crypt_schemes, get_crypt_handler
        ...
        if not supported:
            ...
            # 1) at least one of zdppy_password_hash's os_crypt detection routines is giving false negative
            # 2) crypt() ONLY supports some hash alg which zdppy_password_hash doesn't know about
        ...
        import zdppy_password_hash.utils as mod
        orig = mod._crypt
        try:
            retval = None
    ...
    def test_consteq(self):
        ...
        from zdppy_password_hash.utils import consteq, str_consteq
    ...
    def test_saslprep(self):
        ...
        from zdppy_password_hash.utils import saslprep as sp
    ...
    def test_splitcomma(self):
        from zdppy_password_hash.utils import splitcomma
    ...
    def test_utf8_truncate(self):
        ...
        utf8_truncate()
        """
        from zdppy_password_hash.utils import utf8_truncate
...
class CodecTest(TestCase):
    """tests bytes/unicode helpers in zdppy_password_hash.utils"""
    ...
    def test_is_ascii_safe(self):
        """test is_ascii_safe()"""
        from zdppy_password_hash.utils import is_ascii_safe
    ...
    def test_is_same_codec(self):
        """test is_same_codec()"""
        from zdppy_password_hash.utils import is_same_codec
...
class Base64EngineTest(TestCase):
    ...
    def test_constructor(self):
        from zdppy_password_hash.utils.binary import Base64Engine, AB64_CHARS
    ...
    def test_ab64_decode(self):
        """ab64_decode()"""
        from zdppy_password_hash.utils.binary import ab64_decode
    ...
    def test_b64s_decode(self):
        """b64s_decode()"""
        from zdppy_password_hash.utils.binary import b64s_decode
    ...
    def test_b64s_encode(self):
        """b64s_encode()"""
        from zdppy_password_hash.utils.binary import b64s_encode
...
class _Base64Test(TestCase):
    ...
    def test_codec(self):
        ...
        engine = self.engine
        from zdppy_password_hash.utils import getrandbytes, getrandstr
        rng = self.getRandom()
        saw_zero = False
        for i in irange(500):
            #
