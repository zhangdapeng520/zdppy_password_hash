"""zdppy_password_hash.tests -- unittests for zdppy_password_hash.crypto._md4"""
#=============================================================================
# imports
#=============================================================================
...
# pkg
# module
from zdppy_password_hash.utils.compat import bascii_to_str, PY3, u
from zdppy_password_hash.crypto.digest import lookup_hash
from zdppy_password_hash.tests.utils import TestCase, skipUnless
# local
__all__ = [
    "_Common_MD4_Test",
    "MD4_Builtin_Test",
...
class MD4_Builtin_Test(_Common_MD4_Test):
    descriptionPrefix = "zdppy_password_hash.crypto._md4.md4()"
    ...
    def setUp(self):
        ...
        if has_native_md4():
            ...
            # by monkeypatching hashlib.new() to ensure we fall back to zdppy_password_hash's md4 class.
            orig = hashlib.new
        ...
        # make sure we're using right constructor.
        self.assertEqual(self.get_md4_const().__module__, "zdppy_password_hash.crypto._md4")
