...
from zdppy_password_hash.tests.utils import TestCase, HandlerCase
from zdppy_password_hash.tests.test_handlers import UPASS_WAV
# module
...
class scram_test(HandlerCase):
    ...
    def test_93_derive_digest(self):
        ...
        # unicode salts accepted as of zdppy_password_hash 1.7 (previous caused TypeError)
