"""tests for zdppy_password_hash.utils.(des|pbkdf2|md4)"""
#=============================================================================
# imports
#=============================================================================
...
from zdppy_password_hash.utils.compat import PY3, u, JYTHON
from zdppy_password_hash.tests.utils import TestCase, TEST_MODE, skipUnless, hb
...
class HashInfoTest(TestCase):
    ...
    descriptionPrefix = "zdppy_password_hash.crypto.digest"
    ...
    def test_norm_hash_name(self):
        ...
        from zdppy_password_hash.crypto.digest import norm_hash_name, _known_hash_names
    ...
    def test_mock_fips_mode(self):
        ...
        """
        from zdppy_password_hash.crypto.digest import lookup_hash, _set_mock_fips_mode
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "zdppy_password_hash.crypto.digest.pbkdf1"
...
from zdppy_password_hash.crypto.digest import pbkdf2_hmac, PBKDF2_BACKENDS

# NOTE: relying on tox to verify this works under all the various backends.
class Pbkdf2Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "zdppy_password_hash.crypto.digest.pbkdf2_hmac() <backends: %s>" % ", ".join(PBKDF2_BACKENDS)
    ...
    def test_backends(self):
        ...
        from zdppy_password_hash.crypto.digest import PBKDF2_BACKENDS
