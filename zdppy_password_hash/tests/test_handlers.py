...
# site
# pkg
from zdppy_password_hash import exc, hash
from zdppy_password_hash.utils import repeat_string
from zdppy_password_hash.utils.compat import irange, PY3, u, get_method_function
from zdppy_password_hash.tests.utils import TestCase, HandlerCase, skipUnless, \
...
def get_handler_case(scheme):
    ...
    for module in _handler_test_modules:
        modname = "zdppy_password_hash.tests." + module
        __import__(modname)
...
class hex_md5_test(HandlerCase):
    ...
    def test_mock_fips_mode(self):
        ...
        from zdppy_password_hash.handlers.digests import create_hex_hash
...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    def test_90_raw(self):
        ...
        from zdppy_password_hash.utils.compat import str_to_bascii
        lmhash = self.handler
...
class sun_md5_crypt_test(HandlerCase):
    ...
    known_correct_configs = [
        ...
        #
        # these tests attempt to verify that zdppy_password_hash is handling
