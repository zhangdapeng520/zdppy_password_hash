"""zdppy_password_hash.tests -- test zdppy_password_hash.totp"""
#=============================================================================
# imports
#=============================================================================
# core
...
from zdppy_password_hash.tests.utils import TestCase, time_call
# subject
from zdppy_password_hash import totp as totp_module
from zdppy_password_hash.totp import TOTP, AppWallet, AES_SUPPORT
# local
__all__ = [
    "EngineTest",
]
...
class AppWalletTest(TestCase):
    descriptionPrefix = "zdppy_password_hash.totp.AppWallet"
...
class TotpTest(TestCase):
    ...
    descriptionPrefix = "zdppy_password_hash.totp.TOTP"
    ...
    vectors = [
        ...
        #-------------------------------------------------------------------------
        # zdppy_password_hash test vectors
        #-------------------------------------------------------------------------
    ...
    def test_totp_token(self):
        ...
        from zdppy_password_hash.totp import TOTP, TotpToken
    ...
    def assertTotpMatch(self, match, time, skipped=0, period=30, window=30, msg=''):
        from zdppy_password_hash.totp import TotpMatch
