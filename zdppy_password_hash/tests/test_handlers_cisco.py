"""
zdppy_password_hash.tests.test_handlers_cisco - tests for Cisco-specific algorithms
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from zdppy_password_hash import hash, exc
...
class _PixAsaSharedTest(UserHandlerMixin, HandlerCase):
    ...
    pix_asa_shared_hashes = [
        ...
        #
        # zdppy_password_hash reference vectors
        #
...
class cisco_pix_test(_PixAsaSharedTest):
    ...
    known_correct_hashes = _PixAsaSharedTest.pix_asa_shared_hashes + [
        #
        # zdppy_password_hash reference vectors (PIX-specific)
        #
        # NOTE: See 'pix_asa_shared_hashes' for general PIX+ASA vectors,
        #       and general notes about the 'zdppy_password_hash reference vectors' test set.
        #
...
class cisco_asa_test(_PixAsaSharedTest):
    ...
    known_correct_hashes = _PixAsaSharedTest.pix_asa_shared_hashes + [
        #
        # zdppy_password_hash reference vectors (ASA-specific)
        #
        # NOTE: See 'pix_asa_shared_hashes' for general PIX+ASA vectors,
        #       and general notes about the 'zdppy_password_hash reference vectors' test set.
        #
...
class cisco_type7_test(HandlerCase):
    ...
    def test_90_decode(self):
        ...
        from zdppy_password_hash.utils import to_unicode, to_bytes
