"""tests for zdppy_password_hash.utils.scrypt"""
#=============================================================================
# imports
#=============================================================================
# core
...
from zdppy_password_hash.utils.compat import PYPY, u, bascii_to_str
from zdppy_password_hash.utils.decor import classproperty
from zdppy_password_hash.tests.utils import TestCase, skipUnless, TEST_MODE, hb
# subject
from zdppy_password_hash.crypto import scrypt as scrypt_mod
# local
__all__ = [
    "ScryptEngineTest",
    "BuiltinScryptTest",
...
class ScryptEngineTest(TestCase):
    descriptionPrefix = "zdppy_password_hash.crypto.scrypt._builtin"

    def test_smix(self):
        """smix()"""
        from zdppy_password_hash.crypto.scrypt._builtin import ScryptEngine
        rng = self.getRandom()
...
#        check_bmix(1, input, output)
    ...
    def test_salsa(self):
        """salsa20()"""
        from zdppy_password_hash.crypto.scrypt._builtin import salsa20
...
class _CommonScryptTest(TestCase):
    ...
    def descriptionPrefix(cls):
        return "zdppy_password_hash.utils.scrypt.scrypt() <%s backend>" % cls.backend
    backend = None
