"""tests for zdppy_password_hash.context"""
#=============================================================================
# imports
#=============================================================================
# core
...
from zdppy_password_hash.context import CryptContext, LazyCryptContext
from zdppy_password_hash.exc import PasslibConfigWarning, PasslibHashWarning
from zdppy_password_hash.utils import tick, to_unicode
from zdppy_password_hash.utils.compat import irange, u, unicode, str_to_uascii, PY2, PY26
import zdppy_password_hash.utils.handlers as uh
from zdppy_password_hash.tests.utils import (TestCase, set_file, TICK_RESOLUTION,
                                 quicksleep, time_call, handler_derived_from)
from zdppy_password_hash.registry import (register_crypt_handler_path,
...
""")
    ...
    sample_1c_bytes = sample_1_unicode.replace(u("[zdppy_password_hash]"),
...
##        self.assertEqual(getdep(cc), ["md5_crypt"])
    ...
    def test_35_to_string(self):
        ...
        self.assertEqual(other, dump.replace("[zdppy_password_hash]","[password-security]"))

        # test unmanaged handler warning
        from zdppy_password_hash.tests.test_utils_handlers import UnsaltedHash
    ...
    def test_48_context_kwds(self):
        ...
        from zdppy_password_hash.hash import des_crypt, md5_crypt, postgres_md5
    ...
    def test_50_rounds_limits(self):
        ...
        # NOTE: formerly issued a warning in zdppy_password_hash 1.6, now just a wrapper for .replace()
    ...
    def test_disabled_hashes(self):
        ...
        # init ref info
        #
        from zdppy_password_hash.exc import UnknownHashError
        from zdppy_password_hash.hash import md5_crypt, unix_disabled
...
class LazyCryptContextTest(TestCase):
    ...
    def test_kwd_constructor(self):
        ...
        register_crypt_handler_path("dummy_2", "zdppy_password_hash.tests.test_context")
