"""tests for zdppy_password_hash.hash -- (c) Assurance Technologies 2003-2009"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from zdppy_password_hash import hash, registry, exc
from zdppy_password_hash.registry import register_crypt_handler, register_crypt_handler_path, \
...
from zdppy_password_hash.tests.utils import TestCase
# module
...
class RegistryTest(TestCase):
    ...
    descriptionPrefix = "zdppy_password_hash.registry"
    ...
    def test_hash_proxy(self):
        """test zdppy_password_hash.hash proxy object"""
        # check dir works
        dir(hash)
    ...
    def test_register_crypt_handler_path(self):
        ...
        sys.modules.pop("zdppy_password_hash.tests._test_bad_register", None)
        register_crypt_handler_path("dummy_bad", "zdppy_password_hash.tests._test_bad_register")
        with warnings.catch_warnings():
            warnings.filterwarnings("ignore", "xxxxxxxxxx", DeprecationWarning)
            h = get_crypt_handler("dummy_bad")
        from zdppy_password_hash.tests import _test_bad_register as tbr
    ...
    def test_handlers(self):
        ...
        from zdppy_password_hash.registry import list_crypt_handlers
        from zdppy_password_hash.tests.test_handlers import get_handler_case, conditionally_available_hashes
        for name in list_crypt_handlers():
