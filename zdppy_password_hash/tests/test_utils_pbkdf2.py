"""
zdppy_password_hash.tests -- tests for zdppy_password_hash.utils.pbkdf2
...
# pkg
# module
from zdppy_password_hash.utils.compat import u, JYTHON
from zdppy_password_hash.tests.utils import TestCase, hb
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "zdppy_password_hash.utils.pbkdf2"
    ...
    def setUp(self):
        ...
        warnings.filterwarnings("ignore", ".*zdppy_password_hash.utils.pbkdf2.*deprecated", DeprecationWarning)

    def test_norm_hash_name(self):
        """norm_hash_name()"""
        from itertools import chain
        from zdppy_password_hash.utils.pbkdf2 import norm_hash_name
        from zdppy_password_hash.crypto.digest import _known_hash_names
...
class Pbkdf1_Test(TestCase):
    """test kdf helpers"""
    descriptionPrefix = "zdppy_password_hash.utils.pbkdf2.pbkdf1()"
    ...
    def test_known(self):
        ...
        from zdppy_password_hash.utils.pbkdf2 import pbkdf1
...
class Pbkdf2_Test(TestCase):
    """test pbkdf2() support"""
    descriptionPrefix = "zdppy_password_hash.utils.pbkdf2.pbkdf2()"
    ...
    def test_known(self):
        """test reference vectors"""
        from zdppy_password_hash.utils.pbkdf2 import pbkdf2
