"""zdppy_password_hash.tests.test_handlers - tests for zdppy_password_hash hash algorithms"""
#=============================================================================
# imports
#=============================================================================
...
from zdppy_password_hash.handlers.bcrypt import IDENT_2, IDENT_2X
from zdppy_password_hash.utils import repeat_string, to_bytes, is_safe_crypt_input
from zdppy_password_hash.utils.compat import irange, PY3
from zdppy_password_hash.tests.utils import HandlerCase, TEST_MODE
from zdppy_password_hash.tests.test_handlers import UPASS_TABLE
# module
...
class _bcrypt_test(HandlerCase):
    ...
    def crypt_supports_variant(self, hash):
        ...
        from zdppy_password_hash.handlers.bcrypt import bcrypt, IDENT_2X, IDENT_2Y
        from zdppy_password_hash.utils import safe_crypt
    ...
    def fuzz_verifier_bcrypt(self):
        ...
        from zdppy_password_hash.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2B, IDENT_2X, IDENT_2Y, _detect_pybcrypt
        from zdppy_password_hash.utils import to_native_str, to_bytes
        try:
            import bcrypt
        except ImportError:
            return
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        from zdppy_password_hash.handlers.bcrypt import (
        ...
        from zdppy_password_hash.handlers.bcrypt import _pybcrypt as bcrypt_mod
    ...
    def fuzz_verifier_bcryptor(self):
        ...
        from zdppy_password_hash.handlers.bcrypt import IDENT_2, IDENT_2A, IDENT_2Y, IDENT_2B
        from zdppy_password_hash.utils import to_native_str
        try:
...
#         "$2a$12$M8mKpW9a2vZ7PYhq/8eJVOUtKxpo6j0zAezu0G/HAMYgMkhPu4fLK"),
    ...
    def test_90_bcrypt_padding(self):
        """test zdppy_password_hash correctly handles bcrypt padding bits"""
        self.require_TEST_MODE("full")
        #
        # prevents reccurrence of issue 25 (https://code.google.com/p/zdppy_password_hash/issues/detail?id=25)
...
class _bcrypt_sha256_test(HandlerCase):
    ...
    def test_calc_digest_v2(self):
        ...
        """
        from zdppy_password_hash.hash import bcrypt
        from zdppy_password_hash.crypto.digest import compile_hmac
        from zdppy_password_hash.utils.binary import b64encode
