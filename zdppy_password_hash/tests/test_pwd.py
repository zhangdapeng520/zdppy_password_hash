"""zdppy_password_hash.tests -- tests for zdppy_password_hash.pwd"""
#=============================================================================
# imports
#=============================================================================
# core
...
class UtilsTest(TestCase):
    ...
    descriptionPrefix = "zdppy_password_hash.pwd"

    def test_self_info_rate(self):
        """_self_info_rate()"""
        from zdppy_password_hash.pwd import _self_info_rate
    ...
    #     """_total_self_info()"""
    #     from zdppy_password_hash.pwd import _total_self_info
    #
...
# import subject
from zdppy_password_hash.pwd import genphrase
simple_words = ["alpha", "beta", "gamma"]

class PhraseGeneratorTest(TestCase):
    """test generation routines"""
    descriptionPrefix = "zdppy_password_hash.pwd.genphrase()"
