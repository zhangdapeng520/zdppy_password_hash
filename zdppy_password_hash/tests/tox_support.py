"""zdppy_password_hash.tests.tox_support - helper script for tox tests"""
#=============================================================================
# init script env
#=============================================================================
import os, sys
...
# main
#=============================================================================
TH_PATH = "zdppy_password_hash.tests.test_handlers"
...
def do_hash_tests(*args):
    ...
    while True:
        if args[0] == "--method":
            ...
            break
    from zdppy_password_hash.tests import test_handlers
